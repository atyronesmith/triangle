...
startQuoteTimer()
updateClock()
addEntry('system', 'Initialized. Log entries are tagged by constraint: <strong>counter</strong> (bull-case), <strong>rebuttal</strong> (skeptic), <strong>debt</strong> (tech debt), <strong>morale</strong> (team health). Try <strong>Run Scenario</strong> (above) for a 52-week cinematic playback, or <strong>Run Monte Carlo</strong> (in the Simulation History panel) for a 200-timeline risk envelope. Move sliders or pick a preset to begin.')
update()
